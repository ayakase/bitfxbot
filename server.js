...
bot.on("message", (message) => {
  ...
  if (messageText.includes("/start") || messageText.includes("keyboard")) {
    const keyboard = [
      ...
      [
        { text: "How to make money from BitFx" },
        { text: "How do I view trade result" },
      ],
      ...
      [
        { text: "Contact with BitFx Admin" },
        { text: "Join the Free channel!" },
      ],
      [{ text: "Can I get free signal ?" }],
      [{ text: "Can I have free trial to test your service?" }],
    ];
    const replyMarkup = {
      keyboard,
    ...
    bot.sendMessage(
      chatId,
      "Some of the most popular and reputable brokers in the industry include Interactive Brokers, TD Ameritrade, Charles Schwab, Fidelity, E*TRADE, and Robinhood"
    );
    ...
    bot.sendMessage(
      chatId,
      "Yes, you can. By introducing a person who subscribes to our signal service or introducing an investor subscribed to our investment plan.\n\nFor each successful referral, you can earn up to 25% commission. Contact us now to learn more about our referral program!",
      { parse_mode: "Markdown" }
    );
  } else if (messageText.includes("hi") || messageText.includes("hello")) {
    bot.sendMessage(chatId, `Nice to meet you ${fullName} \n 😍`);
  } else if (
    (messageText.includes("who") || messageText.includes("what")) &&
    (messageText.includes("r") || messageText.includes("are")) &&
    (messageText.includes("you") || messageText.includes("u"))
  ) {
    bot.sendMessage(
      chatId,
      "We are a community of talented, passionate, and independent thinkers who share a commitment for excellence. By fostering a culture of openness, transparency, we strive to unlock the most complex questions in investment strategy. "
    );
    ...
    bot.sendMessage(
      chatId,
      `Please contact our <b>Admin</b> at: <a href="t.me/BitFxSignalsTeam"> BitFx Admin </a> for further details `,
      { parse_mode: "HTML" }
    );
    ...
    bot.sendMessage(
      chatId,
      "We accept Paypal, Skrill, Crypto (ETH, BTC, Solana, USDT, BNB, ADA,…). For detail instruction, please contact us."
    );
    ...
    bot.sendMessage(
      chatId,
      `It depends on what plan you choose, but at most you can make up to $3000-5000 per month with our services!`
    );
    ...
    bot.sendMessage(
      chatId,
      "These are the Forex Signal plans that we offer, choose one to see detail:",
      {
        reply_markup: {
          inline_keyboard: [
            ...
            [
              {
                text: "Standard Plan - $84 .99",
                callback_data: "forexstandard",
              },
            ],
    ...
    bot.sendMessage(
      chatId,
      "These are the Crypto Signal plans that we offer, choose one to see detail:",
      {
        reply_markup: {
          inline_keyboard: [
    ...
    bot.sendMessage(
      chatId,
      "We also give you an oppoturnity to invest in our service and get high passive income:",
      {
        reply_markup: {
          inline_keyboard: [
            ...
            [
              {
                text: "Institutional - 1$ Daily",
                callback_data: "institutional",
              },
            ],
          ],
        },
    ...
    bot.sendMessage(
      chatId,
      "We also assist our dear customer with the Packages and System Installation service:",
      {
        reply_markup: {
          inline_keyboard: [
            ...
            [
              {
                text: "System Installation - $250",
                callback_data: "systeminstall",
              },
            ],
          ],
        },
    ...
    bot.sendMessage(
      chatId,
      `Sorry, I wasn't trained for this question, please contact our <b>Admin</b> at: <a href="t.me/BitFxSignalsTeam"> BitFx Admin </a> .If the button happens to be hidden, simple type <b>keyboard</b> into the chat to make it appear again`,
      { parse_mode: "HTML" }
    );
  }
});
